...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/api/posts')) {
            // show_post
            if (preg_match('#^/api/posts/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ('GET' !== $canonicalMethod) {
                    $allow[] = 'GET';
                    goto not_show_post;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'show_post')), array (  '_controller' => 'AppBundle\\Controller\\Api\\PostController::showPost',));
            }
            not_show_post:
